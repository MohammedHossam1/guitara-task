...
const BreadCrump = () => {
    ...
    return (
        <div className="h-30 text-center lg:h-[20rem] relative overflow-hidden flex items-center justify-center flex-col">
            <Image src="/bread.jpg" alt="logo" width={2000} height={2000} className="object-cover absolute inset-0  flex items-center justify-center w-full h-full opacity-50" />
